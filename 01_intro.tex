...
as it enables sophisticated 
behavioral/\allowbreak anomaly/\allowbreak causality analyses, in 
varied domains ranging from network diagnostics and security breach detection, 
to algorithmic trading or click path optimization.
This trend prompted the addition of pattern matching constructs to many 
querying and stream processing engines such as the 
Event Processing Language (EPL), 
Oracle's \texttt{MATCH\_RECOGNIZE}~\cite{oracle_mr}, 
TerraData's \texttt{npath} operator or 
