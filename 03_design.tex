...
% Since the number of purchase events P are likely to be much lower than the search
% or read review events, performing a broadcast join wrt.\ to the P events might
% prove to be the optimum execution plan for this pattern. One of the key insights
% of this paper is that representing a pattern as a SQL query provides significant
...
There are many different ways to approach data abstraction.  For example, hashing
